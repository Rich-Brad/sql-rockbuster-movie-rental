-- Rockbuster wanted to know the count of customers in each country and the top customer count in the top five countries. I did the inner join
-- for customer, address, city, and country and did a left join for cust_id and total_amount_paid, and grouped by country,top_5_customers_cte 
-- finally order by count desc
